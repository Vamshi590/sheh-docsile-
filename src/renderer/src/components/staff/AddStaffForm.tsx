...
const AddStaffForm: React.FC<AddStaffFormProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!isEditing) {
      ...
      onSubmit({ ...formData, passwordHash: password });
    } else {
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-patients" className="ml-2 block text-sm text-gray-700">
                      Patients Module
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-prescriptions" className="ml-2 block text-sm text-gray-700">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-medicines" className="ml-2 block text-sm text-gray-700">
                      Medicines Module
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-opticals" className="ml-2 block text-sm text-gray-700">
                      Opticals Module
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-receipts" className="ml-2 block text-sm text-gray-700">
                      Receipts Module
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-analytics" className="ml-2 block text-sm text-gray-700">
                      Analytics Module
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-operations" className="ml-2 block text-sm text-gray-700">
                      Operations Module
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-reports" className="ml-2 block text-sm text-gray-700">
                      Reports Module
                    </label>
                  </div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-duesFollowUp" className="ml-2 block text-sm text-gray-700">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                    />
                    <label htmlFor="permission-staff" className="ml-2 block text-sm text-gray-700 font-semibold text-blue-600">
